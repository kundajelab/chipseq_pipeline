...
mkdir -p ${WORK_ROOT}/$NAME; cd ${WORK_ROOT}/$NAME; bds $SCRIPT -bam1 $BAM1 -bam2 $BAM2 -ctl_bam1 ${CTL_BAM1} -chrsz $CHRSZ -rm_chr_from_tag "_" -callpeak macs2
...
ADD="-callpeak macs2 -nth_macs2 1"
...
mkdir -p ${WORK_ROOT}/$NAME; cd ${WORK_ROOT}/$NAME; bds $SCRIPT -bam1 $BAM1 -bam2 $BAM2 -ctl_bam1 ${CTL_BAM1} -chrsz $CHRSZ -rm_chr_from_tag "_" -nth_spp 1 -wt_spp 24h $ADD
...
BAM2=${DATA_ROOT}/$NAME/wgEncodeBroadHistoneGm12878H3k27me3StdRawDataRep2.bam
CTL_BAM1=${DATA_ROOT}/$NAME/wgEncodeBroadHistoneGm12878ControlStdRawDataPooled.bam
mkdir -p ${WORK_ROOT}/$NAME; cd ${WORK_ROOT}/$NAME; bds $SCRIPT -bam1 $BAM1 -bam2 $BAM2 -ctl_bam1 ${CTL_BAM1} -chrsz $CHRSZ -rm_chr_from_tag "other|ribo|mito|_" -callpeak macs2
...
BAM2=${DATA_ROOT}/$NAME/wgEncodeBroadHistoneGm12878H3k9me3StdRawDataRep2.bam
CTL_BAM1=${DATA_ROOT}/$NAME/wgEncodeBroadHistoneGm12878ControlStdRawDataPooled.bam
mkdir -p ${WORK_ROOT}/$NAME; cd ${WORK_ROOT}/$NAME; bds $SCRIPT -bam1 $BAM1 -bam2 $BAM2 -ctl_bam1 ${CTL_BAM1} -chrsz $CHRSZ -rm_chr_from_tag "other|ribo|mito|_" 3 -callpeak macs2
...
BAM2=${DATA_ROOT}/$NAME/wgEncodeHaibTfbsA549NrsfV0422111Etoh02RawDataRep2.bam
CTL_BAM1=${DATA_ROOT}/$NAME/wgEncodeHaibTfbsA549RxlchV0422111Etoh02RawDataRep1.bam
mkdir -p ${WORK_ROOT}/$NAME; cd ${WORK_ROOT}/$NAME; bds $SCRIPT -bam1 $BAM1 -bam2 $BAM2 -ctl_bam1 ${CTL_BAM1} -chrsz $CHRSZ -rm_chr_from_tag "other|ribo|mito|_" -nth_spp 1 -wt_spp 24h $ADD
